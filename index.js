...
//connect database
mongoose.connect(process.env.MOVIES4U_1, {
...
let allowedOrigins = [
 ...
 "https://themovies4u.netlify.app/login",
 "https://themovies4u.netlify.app/movies",
 "https://themovies4u.netlify.app/user",
...
app.put(
  ...
  [
    ...
    check(
      "Username",
      "Username contains non-alphanumeric characters, not allwed."
    ).isAlphanumeric(),
    check("Password", "Password is required").not().isEmpty(),
